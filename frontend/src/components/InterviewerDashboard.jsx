...
//             <h2>Total Interviews Conducted: {totalInterviews}</h2>

//             {interviews.map((interview) => (
//                 <div key={interview._id}>
//                     <p>Applicant: {interview?.applicantId.name}</p>
//                     <p>Job Title: {interview?.jobId.title}</p>

//                     <div>
//                         <button onClick={() => handleStatusChange(interview.applicantId._id, "Shortlisted")}>
//                             Shortlist
//                         </button>
//                         <button onClick={() => handleStatusChange(interview.applicantId._id, "Rejected")}>
//                             Reject
//                         </button>
//                         <button onClick={() => handleStatusChange(interview.applicantId._id, "Pending")}>
//                             Pending
//                         </button>
//                     </div>
//                 </div>
